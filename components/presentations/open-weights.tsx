    ...
    >
      ...
      <PresentationSlide>
        <div className="grid gap-[clamp(0.8rem,2.3vw,2rem)]">
          ...
          <div className="grid gap-[clamp(0.7rem,1.4vw,1.2rem)] border-t border-neutral-300 pt-[clamp(0.7rem,1.5vw,1.3rem)] dark:border-neutral-700 sm:grid-cols-2">
            <div>
              <p className="!mt-0 font-[var(--font-presentation-mono)] !text-[clamp(0.55rem,0.8vw,0.7rem)] tracking-[0.09em] !text-neutral-500 uppercase dark:!text-neutral-400">
                Because
              </p>
